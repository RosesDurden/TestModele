...
namespace CD67.ModeleMVC.Factory
{
	...
	public partial class VikingFactory : Internal.BaseFactory<Entity.Viking>
	{
		...
		public VikingFactory(ModeleMVCEntities dbContext, bool AsNoTracking = false, bool EnableMultipleOptimization = false) : base(dbContext, AsNoTracking, EnableMultipleOptimization) { }
	}
}
